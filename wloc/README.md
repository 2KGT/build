...
- **wloc - Đặt vị trí địa lý**: https://www.icloud.com/shortcuts/a82717d8fdad4e6280866fcf911173f7
- **wloc - Khôi phục vị trí thật**: https://www.icloud.com/shortcuts/f42632d406504f24a2cd163af4fe012f

**Cách dùng**

- **Đặt vị trí:** Trong app Bản đồ, chọn vị trí (nhấn giữ trên bản đồ) → Chia sẻ → chọn "wloc - Đặt vị trí địa lý" để chuyển đổi.
  - Apple Maps: chọn điểm → Chia sẻ → "wloc - Đặt vị trí địa lý"
  - Bản đồ Cao Đức (Amap): chọn điểm → Chia sẻ → **Thêm** → "wloc - Đặt vị trí địa lý"
- **Xoá vị trí:** Nhấn "wloc - Khôi phục vị trí thật" để khôi phục định vị thật.
