...
// --- THAY THẾ LOGIC KHỞI TẠO MENU CÀI ĐẶT TẠI ĐÂY ---

%hook YTSettingsGroupData

- (NSArray <NSNumber *> *)orderedCategories {
    // Kiểm tra nếu không phải menu chính (type != 1) hoặc có tweak khác can thiệp thì trả về gốc
    if (self.type != 1 || class_getClassMethod(objc_getClass("YTSettingsGroupData"), @selector(tweaks)))
        return %orig;
        
    NSMutableArray *mutableCategories = %orig.mutableCopy;
    // Chèn danh mục YouTube Plus (YTLiteSection) vào vị trí đầu tiên của danh sách cài đặt
