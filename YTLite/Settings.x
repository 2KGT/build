...
// --- PHẦN FIX HIỂN THỊ NÚT TRÊN MỌI PHIÊN BẢN YOUTUBE ---

// 1. Hỗ trợ hiển thị trên YouTube phiên bản mới (Cơ chế Group Data)
...
// 2. Hỗ trợ hiển thị trên YouTube phiên bản cũ (Cơ chế Category Order)
